...
def download_model():
    ...
    Ham nay duoc goi mot lan khi module duoc import. Tren EC2, boto3 tu dong
    su dung temporary credentials cua IAM instance role.
    """
...
def score(req: ScoreRequest):
    ...
    if len(req.features) != 10:
        raise HTTPException(
            status_code=400,
            detail="features must contain exactly 10 values",
        )
